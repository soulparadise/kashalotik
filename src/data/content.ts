...
export const trainers = [
  { name: 'Эльвира', image: image('elvira.webp'), role: 'Грудничковое, раннее, дошкольное и восстановительное плавание', quote: 'Слышу ребёнка, чувствую воду — сопровождаю к осознанному плаванию.' },
  { name: 'Алина', image: image('alina.webp'), role: 'Грудничковое, раннее, дошкольное и реабилитационное плавание', quote: 'Современные методики и увлекательные занятия — здоровье без границ.' },
  { name: 'Полина', image: image('polina.webp'), role: 'Грудничковое, раннее и дошкольное плавание', quote: 'Вместо правил — доверие. Вместо гребков — радость.' },
  { name: 'Сергей', image: image('sergey.webp'), role: 'Грудничковое, раннее, дошкольное и восстановительное плавание', quote: 'Каждый ребёнок уникален, каждое занятие — особенное.' },
  { name: 'Наталья', image: image('natalya.webp'), role: 'Грудничковое, раннее, дошкольное и восстановительное плавание', quote: 'Не заставляю, а увлекаю. Вода должна быть в радость.' },
] as const;
