...
export const promotions: Promotion[] = [
  ...
  {
    title: 'Снова в бассейн',
    badge: 'Скидка до 10%',
    description: 'Специальные условия для клиентов, которые возвращаются к занятиям после перерыва.',
    conditions: [
      'Если вы не посещали занятия более 60 дней',
      'Скидка 10% на абонементы на 8 и 12 занятий',
      'Скидка 5% на абонемент на 4 занятия',
    ],
  },
];
