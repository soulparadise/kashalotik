...
export const trialOffer = {
  ...
  conditions: [
    'Пробное в подарок при покупке абонемента на 8 или 12 занятий в день визита.',
    'При покупке абонемента на 4 занятия стоимость пробного — 750 ₽.',
    'При покупке абонемента стоимость пересчитывается.',
    'Перенос или отмена — до 20:00 предшествующего дня.',
  ],
} as const;
